      ...
      promise: function promise(options) {
        ...
        if ((0, _utils.isPromise)(next)) {
          ...
          next.then(function (data) {
            return dispatch((0, _store.loadSuccess)(key, data, options));
          }, function (err) {
            return dispatch((0, _store.loadFail)(key, err, options));
          });
        } else if (next) {
  ...
  return function (Component) {
    ...
    var finalMapStateToProps = function finalMapStateToProps(state, ownProps) {
      var asyncStateToProps = asyncItems.reduce(function (result, _ref) {
        ...
        return (0, _extends4.default)({}, result, (_extends2 = {}, _extends2[key] = state[key], _extends2));
      }, {});
      ...
      return (0, _extends4.default)({}, mapStateToProps(state, ownProps), asyncStateToProps);
    };
